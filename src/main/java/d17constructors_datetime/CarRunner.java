...
public class CarRunner {
    public static void main(String[] args) {
        ...
        System.out.println("c1 = " + c1); //reference alindi //Car{brand='BMW', model='3.20', year=2024, hybrid=false}
        System.out.println("c2 = " + c2); //reference alindi //Car{brand='Audi', model='A4', year=2018, hybrid=false}
