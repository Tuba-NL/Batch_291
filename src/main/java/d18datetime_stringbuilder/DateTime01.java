...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println("formattedTime = " + formattedTime);//10:14 ÖÖ

        //-----------------------------------
        //Ornek 2: Tarih’i formatlayalim
        LocalDate myCurrentDate = LocalDate.now();
        System.out.println("myCurrentDate = " + myCurrentDate);//2024-10-04
        ...
        System.out.println("dateInTokyo = " + dateInTokyo);//2024-10-04//Arastirma Odevi: Java bu bilgiyi internetten mi cekiyor?

        //Amsterdam’da ayin kaci?
        LocalDate dateInAmsterdam = LocalDate.now(ZoneId.of("Europe/Amsterdam"));
        System.out.println("dateInAmsterdam = " + dateInAmsterdam);//2024-10-04

        //Tokyo’da saat kac?
        LocalTime timeInTokyo = LocalTime.now(ZoneId.of("Asia/Tokyo"));
        System.out.println("timeInTokyo = " + timeInTokyo);//17:34:39.123211600
